...
const struct regval_list ov7670_default_regs[] PROGMEM = {//from the linux driver
  ...
  */
  ...
  { REG_COM8, COM8_FASTAEC | COM8_AECSTEP },//0x80 0x40  
  { REG_GAIN, 0 }, 
  { REG_AECH, 0 },
...
static void captureImg(uint16_t wg, uint16_t hg){
  ...
  while (y--)
  {
    ...
    while (x--)
    {
      ...
      bitWrite(pixel, 0, (PIND & 0b00010000));
      bitWrite(pixel, 1, (PINC & 0b00001000));
      bitWrite(pixel, 2, (PIND & 0b00100000));
      bitWrite(pixel, 3, (PINC & 0b00000100));
      bitWrite(pixel, 4, (PIND & 0b01000000));
      bitWrite(pixel, 5, (PINC & 0b00000010));
      bitWrite(pixel, 6, (PIND & 0b10000000));
      bitWrite(pixel, 7, (PINC & 0b00000001));
      ...
      while ((PIND & 4));//wait for low
      //not sent second byte
      while (!(PIND & 4));//wait for high
    }
  }
  UDR0 = 0x10; //sending LF for serial closing
}
