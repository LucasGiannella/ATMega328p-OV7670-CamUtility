...
//      pixel |= ( (PIND & 0b00010000) << 7);
        ...
        bitWrite(pixel, 0, (PINC & 0b00000001));
        bitWrite(pixel, 1, (PIND & 0b10000000));
        bitWrite(pixel, 2, (PINC & 0b00000010));
        bitWrite(pixel, 3, (PIND & 0b01000000));
        bitWrite(pixel, 4, (PINC & 0b00000100));
        bitWrite(pixel, 5, (PIND & 0b00100000));
        bitWrite(pixel, 6, (PINC & 0b00001000));
        bitWrite(pixel, 7, (PIND & 0b00010000));

//      pixel |= ( (PINC & 0b00000001) << 7);
//      pixel |= ( (PIND & 0b10000000) << 6);
//      pixel |= ( (PINC & 0b00000010) << 5);
//      pixel |= ( (PIND & 0b01000000) << 4);
//      pixel |= ( (PINC & 0b00000100) << 3);
//      pixel |= ( (PIND & 0b00100000) << 2);
//      pixel |= ( (PINC & 0b00001000) << 1);
//      pixel |= ( (PIND & 0b00010000) << 0);

      //UDR0 = (PINC & 0b00000001) | (PIND & 0b10000000) | (PINC & 0b00000010) | (PIND & 0b01000000) | (PINC & 0b00000100) | (PIND & 0b00100000) | (PINC & 0b00001000) | (PIND & 0b00010000);
