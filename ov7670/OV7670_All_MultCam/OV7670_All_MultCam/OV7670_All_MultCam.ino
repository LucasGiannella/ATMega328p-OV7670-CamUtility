...
const struct regval_list yuv422_ov7670[] PROGMEM = {
  ...
  { REG_COM9, 0x5A }, /* 128x gain ceiling; 0x8 is reserved bit */
...
/////////////////////////MEGA/////////////////////////////
//void error_led(void){
//  DDRB |= 128;//make sure led is output
//  while (1){//wait for reset
//    PORTB ^= 128;// toggle led
//    _delay_ms(100);
//  }
//}
//////////////////////////////////////////////////////////
...
/////////////////////////MEGA/////////////////////////////
//void arduinoMegaInut(void) {
//  cli();//disable interrupts
//  
//    /* Setup the 8mhz PWM clock
//  * This will be on pin 10*/
//  DDRB |= (1 << 4);//pin 10
//  ASSR &= ~(_BV(EXCLK) | _BV(AS2));
//  TCCR2A = (1 << COM2A0) | (1 << WGM21) | (1 << WGM20);
//  TCCR2B = (1 << WGM22) | (1 << CS20);
...
/////////////////////////UNO/////////////////////////////
static void captureImgUno(uint16_t wg, uint16_t hg){
  uint16_t y, x;
...
/////////////////////////MEGA/////////////////////////////
//static void captureImgMega(uint16_t wg, uint16_t hg)
//{
//  uint16_t y, x;
//
//  StringPgm(PSTR("*RDY*"));
...
//      
//      UDR0 = (PINF & 15) | (PING & 32) | (PINE & 8) | (PINH & 8) | (PINH & 16);
//      //UDR0 = (PINF & 15) | (PINH & 16) | (PINH & 8) | (PINE & 8) |  (PING & 32)  ;
//      while (!(UCSR0A & (1 << UDRE0)));//wait for byte to transmit
//      
...
//
//void useCam1(){
//  DDRB |= (0 << 4);// 0 on pin 12
//  DDRB |= (1 << 5);// 1 on pin 13
//}
//
//void useCamA(){
//  DDRB |= (1 << 4);// 1 on pin 12
//  DDRB |= (0 << 5);// 0 on pin 13
//}
